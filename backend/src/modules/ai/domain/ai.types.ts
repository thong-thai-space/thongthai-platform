...
export const aiConversationIncludes = Prisma.validator<Prisma.AiConversationDefaultArgs>()({
  include: {
...
export const aiApplyRequestCreateIncludes = Prisma.validator<Prisma.AiApplyRequestDefaultArgs>()({
  include: {
...
export const aiApplyRequestListIncludes = Prisma.validator<Prisma.AiApplyRequestDefaultArgs>()({
  include: {
    project: { select: { id: true, name: true } },
    requester: { select: { id: true, name: true, role: true } },
...
export const aiApplyRequestReviewIncludes = Prisma.validator<Prisma.AiApplyRequestDefaultArgs>()({
  include: {
    project: { select: { id: true, name: true, ownerId: true, clientId: true } },
  },
});
...
export const aiProgressProjectIncludes = Prisma.validator<Prisma.ProjectDefaultArgs>()({
...
export const aiStrategicProjectIncludes = Prisma.validator<Prisma.ProjectDefaultArgs>()({
  include: {
...
export const aiAuditLogIncludes = Prisma.validator<Prisma.AiUsageAuditDefaultArgs>()({
  include: {
