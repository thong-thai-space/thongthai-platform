    ...
    <main className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: tMeta('termsAndConditions.title').split('|')[0].trim(), url: pageUrl },
        ]}
      />
      <div className="tts-brand-surface p-7 sm:p-9">
      <h1 className="tts-landing-title text-3xl font-bold tracking-tight text-foreground">Terms and Conditions</h1>
