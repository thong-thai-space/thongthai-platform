  ...
  return (
    <>
      ...
      <main className="flex flex-1 overflow-hidden">
        {/* Conversation list */}
        <div className="tts-workspace-surface ml-2 mr-2 mt-2 w-80 shrink-0 overflow-y-auto border-r border-border">
          <div className="p-4">
        ...
        {/* Message area */}
        <div className="tts-workspace-surface mr-2 mt-2 flex flex-1 flex-col">
          {!selectedUserId ? (
            ...
            <>
              ...
              >
                <input
                  ...
                  className="tts-form-field flex-1 rounded-lg border border-border bg-background px-3 py-2 text-sm focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent"
                />
                <button
                  type="submit"
