          ...
          <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
            <AnimatePresence>
              {showWelcomeNudge && (
                ...
                >
                  <p className="font-medium text-foreground">{t('portalChatOnlineTitle')}</p>
                  <p className="mt-0.5 text-muted-foreground">{t('portalChatOnlineSubtitle')}</p>
                </motion.button>
              )}
            </AnimatePresence>
          ...
          >
            ...
            <div className="flex items-center justify-between rounded-t-2xl bg-accent px-4 py-3 text-accent-foreground">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-semibold">{t('portalChatHeaderTitle')}</span>
              </div>
            ...
            <form onSubmit={handleSend} className="flex items-center gap-2 border-t border-border p-3">
              <input
                ...
                placeholder={t('portalChatInputPlaceholder')}
