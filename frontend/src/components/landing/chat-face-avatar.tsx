...
const AVATAR_CONFIG = {
  ...
  fullbody: {
    ...
    imageUrl: '/models/astronaut-face.png',
    modelScale: 0.95,
    modelPosition: [0, -1.15, 0] as [number, number, number],
    cameraPosition: [0, 0.15, 8.2] as [number, number, number],
    cameraFov: 32,
    mobileModelScale: 0.88,
    mobileModelPosition: [0, -1.0, 0] as [number, number, number],
    mobileCameraPosition: [0, 0.22, 8.8] as [number, number, number],
    mobileCameraFov: 34,
    clipCircle: false,
    swayAmplitude: 0.08,
    swaySpeed: 0.28,
